...
3. **Mempersiapkan Arduino IDE**
   - Diperlukan sebuah *Universal Universal Telegram Bot Library* <a href="https://github.com/witnessmenow/Universal-Arduino-Telegram-Bot" target="_blank">Brian Lough</a> yang menyediakan antarmuka yang mudah untuk API Bot Telegram.
